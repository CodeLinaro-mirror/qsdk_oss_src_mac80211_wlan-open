 ...
 */
static int ath11k_mac_op_set_rts_threshold(struct ieee80211_hw *hw, int radio_idx,
					   u32 value)
{
	struct ath11k *ar = hw->priv;
...
static int ath11k_mac_op_set_frag_threshold(struct ieee80211_hw *hw, int radio_idx,
					    u32 value)
{
