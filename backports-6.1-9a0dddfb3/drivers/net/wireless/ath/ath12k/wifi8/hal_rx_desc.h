...
#define QCN9625_MPDU_START_SELECT_MPDU_START_TAG			BIT(0)
#define QCN9625_MPDU_START_SELECT_INFO0_REO_QUEUE_DESC_LO		BIT(1)
#define QCN9625_MPDU_START_SELECT_INFO1_PN_31_0				BIT(2)
#define QCN9625_MPDU_START_SELECT_PN_95_32				BIT(3)
#define QCN9625_MPDU_START_SELECT_PN_127_96_INFO2			BIT(4)
#define QCN9625_MPDU_START_SELECT_PEER_MDATA_INFO3_PHY_PPDU_ID		BIT(5)
#define QCN9625_MPDU_START_SELECT_AST_IDX_SW_PEER_ID_INFO4		BIT(6)
#define QCN9625_MPDU_START_SELECT_INFO5_INFO6				BIT(7)
...
#define QCN9625_MPDU_START_SELECT_HT_CTRL_INFO7				BIT(12)
#define QCN9625_MPDU_START_SELECT_ML_ADDR1_47_0_ML_ADDR2_15_0		BIT(13)
#define QCN9625_MPDU_START_SELECT_ML_ADDR2_47_16_INFO8			BIT(14)
#define QCN9625_MPDU_START_SELECT_RES_0_RES_1				BIT(15)

#define QCN9625_MPDU_START_WMASK (QCN9625_MPDU_START_SELECT_INFO1_PN_31_0 |	\
		QCN9625_MPDU_START_SELECT_PN_95_32 |				\
		QCN9625_MPDU_START_SELECT_AST_IDX_SW_PEER_ID_INFO4 |		\
		QCN9625_MPDU_START_SELECT_INFO5_INFO6 |				\
...
#define QCN9625_MSDU_END_SELECT_SA_SW_PER_ID_INFO5_SA_DA_ID		BIT(6)
#define QCN9625_MSDU_END_SELECT_INFO6_FSE_METADATA			BIT(7)
#define QCN9625_MSDU_END_SELECT_CCE_MDATA_TCP_UDP_CSUM_INFO7_IP_LEN	BIT(8)
#define QCN9625_MSDU_END_SELECT_INFO8_INFO9				BIT(9)
#define QCN9625_MSDU_END_SELECT_INFO10_INFO11				BIT(10)
#define QCN9625_MSDU_END_SELECT_VLAN_CTAG_STAG_CI_PEER_MDATA		BIT(11)
#define QCN9625_MSDU_END_SELECT_INFO12_AND_FLOW_ID_TOEPLITZ		BIT(12)
...
#define QCN9625_MSDU_END_SELECT_RES0_SA_47_0				BIT(15)
#define QCN9625_MSDU_END_SELECT_INFO13_INFO14				BIT(16)

#define QCN9625_MSDU_END_WMASK (QCN9625_MSDU_END_SELECT_MSDU_END_TAG |	\
		QCN9625_MSDU_END_SELECT_SA_SW_PER_ID_INFO5_SA_DA_ID |	\
		QCN9625_MSDU_END_SELECT_INFO10_INFO11 |			\
		QCN9625_MSDU_END_SELECT_INFO12_AND_FLOW_ID_TOEPLITZ |	\
		QCN9625_MSDU_END_SELECT_PPDU_START_TS_63_32_PHY_MDATA |	\
		QCN9625_MSDU_END_SELECT_INFO13_INFO14 | \
		QCN9625_MSDU_END_SELECT_CCE_MDATA_TCP_UDP_CSUM_INFO7_IP_LEN | \
		QCN9625_MSDU_END_SELECT_INFO6_FSE_METADATA)
