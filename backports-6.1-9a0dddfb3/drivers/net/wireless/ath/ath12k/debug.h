...
enum ath12k_debug_mask {
	...
	ATH12K_DBG_DP_MON_TX		= BIT_ULL(42),
	ATH12K_DBG_MMESH		= BIT_ULL(43),
	ATH12K_DBG_CU			= BIT_ULL(44),
	ATH12K_DBG_IPA			= BIT_ULL(45),
	ATH12K_DBG_SPECTRAL		= BIT_ULL(46),
	ATH12K_DBG_SMD			= BIT_ULL(47),
