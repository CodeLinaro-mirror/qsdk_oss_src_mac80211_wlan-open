...
#define ATH12K_EGRESS_MACID_MASK	GENMASK(3, 0)
#define ATH12K_PPE_VP_NUM		GENMASK(15, 8)
#define ATH12K_FSE_MAGIC_NUM		0xAA
#define ATH12K_FSE_MAGIC_NUM_MASK	GENMASK(23, 16)

#define ATH12K_DP_RX_FSE_FL_VP_NUM_MASK		GENMASK(7, 0)
#define ATH12K_DP_RX_FSE_FL_EGRESS_MACID_MASK	GENMASK(11, 8)
#define ATH12K_DP_RX_FSE_FL_EGRESS_MACID_SHIFT	0x8
