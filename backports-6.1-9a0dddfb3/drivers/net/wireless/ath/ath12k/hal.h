...
enum hal_wbm_tqm_rel_reason_ext {
	HAL_TASC_REASON_HW_COMPLETION = HAL_WBM_TQM_REL_REASON_MAX,
	HAL_TASC_REASON_HW_DROP1,
	HAL_TASC_REASON_HW_DROP2,
	HAL_TASC_REASON_HW_FAILED,
	HAL_WBM_TQM_REL_REASON_MAX_EXT,
};
