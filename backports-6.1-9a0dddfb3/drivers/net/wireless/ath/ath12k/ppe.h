...
#define PPEDS_IRQ_NEXT_RING 3
#define PPE2TCL_MAX_RINGS 2
#define REO2PPE_MAX_RINGS 2
...
struct ath12k_ppe {
	...
	struct dp_srng reo2ppe_ring[REO2PPE_MAX_RINGS];
	struct dp_srng ppe2tcl_ring[PPE2TCL_MAX_RINGS];
