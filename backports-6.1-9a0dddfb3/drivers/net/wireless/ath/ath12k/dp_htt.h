...
enum htt_h2t_msg_type {
	...
	HTT_H2T_MSG_TYPE_MPDUQ_AND_MSDUQ_INFO		= 0x2a,
...
#define HTT_RX_EXT_MON_FILTER_TLV_FLAGS \
	(HTT_RX_FILTER_TLV_FLAGS_MPDU_START | \
	HTT_RX_FILTER_TLV_FLAGS_MSDU_START | \
	HTT_RX_FILTER_TLV_FLAGS_RX_PACKET | \
	HTT_RX_FILTER_TLV_FLAGS_MPDU_END | \
...
#define HTT_RX_RING_64B_DMA_LENGTH		0x1
...
#define HTT_TX_FILTER_MASK_IN4_UPSTREAM_TLV_FLAGS3			GENMASK(15, 0)
...
#define HTT_TX_FILTER_TLV_FLAGS3_UHR_PREAMBLE_ALL	      \
...
#define HTT_TX_FILTER_MASK_IN4_DOWNSTREAM_TLV_FLAGS1			GENMASK(31, 16)

#define HTT_TX_FILTER_TLV_DS_FLAGS1_WIFI_RANGING_USER_DETAILS		BIT(0)
#define HTT_TX_FILTER_TLV_DS_FLAGS1_WIFI_HDR_CTRL_PROT_PEER_ENTRY	BIT(1)

#define HTT_TX_FILTER_TLV_DS_FLAGS1_ALL \
	(HTT_TX_FILTER_TLV_DS_FLAGS1_WIFI_RANGING_USER_DETAILS | \
	 HTT_TX_FILTER_TLV_DS_FLAGS1_WIFI_HDR_CTRL_PROT_PEER_ENTRY)
...
#define HTT_T2H_PEER_MAP3_INFO3_NEXT_HOP_M	HTT_T2H_PEER_MAP_INFO2_NEXT_HOP_M
#define HTT_T2H_PEER_MAP3_INFO3_NEXT_HOP_S	HTT_T2H_PEER_MAP_INFO2_NEXT_HOP_S
