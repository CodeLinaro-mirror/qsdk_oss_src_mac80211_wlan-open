...
enum dp_mon_filter_mode {
	...
	DP_MON_FILTER_PKTLOG_HYBRID_TX,
...
void ath12k_dp_tx_htt_rx_mgmt_fpmo_flag0_filter_set(u32 *ptr, u16 filter);
void ath12k_dp_tx_htt_rx_ctrl_fpmo_flag0_filter_set(u32 *ptr, u16 filter);
